/**
* respect to https://github.com/zhangmin173/postcss-pxtoem/
**/
...
export default postcss.plugin('postcss-plugin-px2em', options => {
  ...
  return css => {
    css.walkDecls((decl, i) => {
      ...
      // if em unit already exists, do not add or replace
